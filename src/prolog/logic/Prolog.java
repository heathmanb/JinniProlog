...
public final class Prolog implements Stateful {
    ...
    private static Prolog cloneProlog(Prolog prolog, String className) {
        Prolog newprolog;
        try {
    ...
    /**
     * Cloned by Prolog classes, synchronized to allow multiple parallel new(..)
     * operations for Prolog objects and agents.
     *
     * @param className Name of the new clone.
     * @return Clone of the default prolog object.
     */
    ...
    /**
     * De facto external constructor - constructs and returns Prolog class as a
     * result of loading a bytecode file returns null if fails.
     * 
     * @param fname Bytecode file name.
     * @return Prolog instance.
     */
    private static Prolog getProlog(String fname) {
        try {
  ...
  // Class variables - COMPILE TIME data
    ...
    /**
     * Creates runtime system and loads byte code file given as argument.
     */
    private Prolog(String wamFile) throws PrologException {
        if (null == wamFile) {
            wamFile = Interact.PROLOG_BYTECODE_FILE;
        }
     ...
     *
     *
     * public Prolog() throws PrologException { this(null); }
     */
    ...
    // problem if classname has already .pl - from find_file ?
        ...
        if (null != source) {
            return source; // already loaded and cloned ###
        }
        source = this;
