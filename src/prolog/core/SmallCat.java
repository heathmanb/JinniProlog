 ...
 * as some basic Category theory operations. Uses BitVectors to represent a
 * small set of morphisms. It can be made to extend either Graph or Cat. We
 * chose to extend Cat so that it can provide a small set of morphisms sharing
 * attributes more efficiently, while allowing also the use of an unbound number
 * of general morphisms with individual attributes - as inherited from Cat. Uses
 * BitSets through RoleMap class.
 */
public class SmallCat extends RankedGraph { // Graph
    ...
    /**
     * Creates a new Small Category (supporting fast processing for a small
     * number of morphisms, known in advance - typical situation in a semantic
     * network)
     */
    SmallCat() {
        super();
