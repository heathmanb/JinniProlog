...
/**
 * Implements (Finite) Categories by extending a Graph to support multiple edges
 * (seen as morphisms) between vertices (seen as a Category's Objects) as well
 * as some basic Category theory operations. Another view of this is as ARGs -
 * attributed relational graphs - where each vertex and each edge is seen as
 * having a set of attributes. It can be made to extend Graph or RankedGraph. It
 * also implements a default IFilter that selects what information makes it into
 * an IGraph that visualizes selected content from this Cat.
 */
public class Cat extends RankedGraph implements IFilter {
    ...
    /**
     * Sets a the value of a property of this vertex. setProp(Object
     * vertex,Object key,Object value)
     * @param vertex
     * @param key
     * @param value
     * @return 
    ...
    /**
     * Gets a the vlaue of a property of this vertex. Object getProp(Object
     * vertex,Object key)
     * @param vertex
     * @param key
     * @return 
    ...
    /**
     * Gets the value of a property of the link between two objects - the can be
     * seen as selecting a morphism between two Objects in a Category.
     * @param from
     * @param to
     * @param m
     * @return 
    ...
    /**
     * Turns a Prolog Term into a Tree-ish Cat. ftype = 0, ctype = 1.
     * 
     * @param T Prolog term
     * @return New cat tree
     */
    ...
    /**
     * Turns a Prolog Term into a Tree-ish Cat. Int params ftype and ctype can
     * be used as hints by visualizers for selecting the shapes/colors/details
